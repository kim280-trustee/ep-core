...
export default function SettingsPage() {
  ...
  function handleSave() {
    ...
    const nextSettings: CompanySettings = {
      ...
      taxEnabled:
        form.taxEnabled ?? settings.taxEnabled,
      taxRate:
        form.taxRate ?? settings.taxRate,
      invoicePrefix:
        form.invoicePrefix ?? settings.invoicePrefix,
      receiptPrefix:
        form.receiptPrefix ?? settings.receiptPrefix,
    ...
    changeLanguage(
      nextSettings.language === "th" ? "th" : "en",
    );
      ...
      <div className="mx-auto max-w-5xl space-y-6">
          ...
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                {t("settings.businessInformationDescription")}
              </p>
            </div>
          </div>
        ...
        <section className="rounded-3xl bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                {t("settings.languageAndCurrencyHelp")}
              </p>
            </div>
          </div>
        ...
        <section className="rounded-3xl bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900">
                {t("settings.documentNumbering")}
              </h2>
              <p className="text-sm text-slate-500">
                {t("settings.documentNumberingDescription")}
              </p>
            </div>
          </div>
        ...
        <section className="flex flex-col gap-4 rounded-3xl bg-white p-6 shadow-sm sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            type="button"
            onClick={handleSave}
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white shadow-sm transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-200"
          >
            <Save size={18} />
            {t("common.save")}
          </button>
