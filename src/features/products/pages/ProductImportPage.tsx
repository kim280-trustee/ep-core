...
export function ProductImportPage(){
  ...
  useEffect(() => {
    ...
    void productService.getAllProducts(tenantId).then((products) => setExisting(products)).catch((loadError) => setError(loadError instanceof Error ? loadError.message : "Could not load existing products."));
  }, [tenantId]);
  ...
  async function importProducts(){
    ...
    try{
      ...
      const refreshed=await productService.getAllProducts(tenantId);setExisting(refreshed);
