  ...
  return (
    <div className="w-full min-w-0 rounded border p-3 sm:p-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button type="button" onClick={() => void refresh()} disabled={loading || refundingOrderId !== null} className="w-full shrink-0 rounded border px-3 py-2 text-sm disabled:opacity-50 sm:w-auto">
