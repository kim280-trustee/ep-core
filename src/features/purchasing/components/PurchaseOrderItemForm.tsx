    ...
    >
      ...
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <div>
          ...
          <input
            ...
            className="mt-2 min-h-12 w-full rounded-lg border-2 border-slate-300 bg-white px-3 py-2.5 text-base font-medium text-slate-900 shadow-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="mt-2 min-h-12 w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="0"
            className="mt-2 min-h-11 w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="mt-2 w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
          />
        </div>
      ...
      <div className="flex flex-wrap items-center gap-3 border-t border-slate-200 pt-5">
        ...
        <button
          ...
          className="inline-flex min-h-11 items-center justify-center rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
        >
          {adding ? "Adding..." : "Add Product to Order"}
        </button>
