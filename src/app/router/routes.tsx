...
import { brandRoutes } from "../../features/brands/routes/brand.routes";
import { unitRoutes } from "../../features/units/routes/unit.routes";
import { supplierRoutes } from "../../features/suppliers/routes/supplier.routes";
import { customerRoutes } from "../../features/customers/routes/customer.routes";
import { warehouseRoutes } from "../../features/warehouses/routes/warehouse.routes";
import { taxRoutes } from "../../features/taxes/routes/tax.routes";
...
import { purchasingRoutes } from "../../features/purchasing/routes/purchasing.routes";
import { goodsReceiptRoutes } from "../../features/purchase-receiving/routes/goods-receipt.routes";
import { purchaseReturnRoutes } from "../../features/purchasing/purchase-returns/routes/purchase-return.routes";
import { salesRoutes } from "../../features/sales/routes/sales.routes";
import { posSalesRoutes } from "../../features/pos-sales/routes/pos-sales.routes";
import { paymentRoutes } from "../../features/payments/routes/payment.routes";
import { receiptRoutes } from "../../features/receipts/routes/receipt.routes";
import { expenseRoutes } from "../../features/expenses/routes/expense.routes";
